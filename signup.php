...
<div class="row">
 ...
 <form form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
   
   <div><h1 style="font-family:candara;text-decoration:underline"><b>Registration Forms For Student</b></h1></div>
   <h5 style="font-family:comic sans ms ;color:red;"><strong>Please Fill In The Forms To Register Here</strong></h5>
  ...
  <input type="password" class="form-control input-lg" name="address" id="address" placeholder="Address" required="" >
  

   <label style="font-family:Lucida fax"><h4>City</h4></label>
  <input type="password" class="form-control input-lg" name="city" id="city" placeholder="City" required="" >
  
  
 <label style="font-family:Lucida fax"><h4>Phone</h4></label>
  <input type="password" class="form-control input-lg" name="phone" id="phone" placeholder="City" required="" ><br/><br/>
